...
public class FluentAttributeMatcher__02__Tracking__SimplestFailAndDescribe {
    ...
    public Description matcher() {
        ...
        final FluentAttributeMatcher<ThingWithString> matcher = Flatts.aTracking(ThingWithString.class)//
